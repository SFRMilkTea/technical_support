...
class Department(models.Model):
    ...
    def __str__(self):
        return self.name  # Возвращаем название отдела как строковое представление
...
class Request(models.Model):
    ...
    creating_date = models.DateField(default=django.utils.timezone.now)
